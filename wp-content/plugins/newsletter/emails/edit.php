        ...
        var tnp_uploader = wp.media({
            ...
            if (!media.attributes.mime.startsWith("image")) {
                if (typeof editor !== "undefined") {
                    editor.getDoc().replaceRange(url, editor.getDoc().getCursor());
                } else {
                ...
                if (typeof editor !== "undefined") {
                    editor.getDoc().replaceRange('<img src="' + url + '">', editor.getDoc().getCursor());
                } else {
        ...
        <form method="post" action="" id="newsletter-form">
            ...
            <div id="tabs">
                ...
                <div id="tabs-a">
                    ...
                    <b>Message ( AR )</b>
                    <br><br>
                        <?php $controls->text('subject_ar', 70, 'Subject'); ?>
                        <input type="button" class="button-primary" value="Add media" onclick="tnp_media()" style="margin-bottom: 10px;">
                        <?php $controls->editor('message_ar', 30); ?>
