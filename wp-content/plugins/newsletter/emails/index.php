...
if ($controls->is_action('copy')) {
    ...
    $subject_ar = get_option( 'newsletter_' . $original->id . '_ar_subject' );
    $message_ar = get_option( 'newsletter_' . $original->id . '_ar_message' );
    ...
    if( $subject_ar ) {
      update_option('newsletter_' . $email_id . '_ar_subject', $subject_ar );
    }
    
    if( $message_ar ) {
      update_option('newsletter_' . $email_id . '_ar_message', $message_ar );
    }
}
