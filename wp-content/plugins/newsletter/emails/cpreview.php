...
$subject_ar = get_option( 'newsletter_' . $email_id . '_ar_subject' );
$message_ar = get_option( 'newsletter_' . $email_id . '_ar_message' );

if( empty( $controls->data['subject_ar'] ) && $subject_ar ) {
  $controls->data['subject_ar'] = $subject_ar;
}

if( empty( $controls->data['message_ar'] ) && $message_ar ) {
  $controls->data['message_ar'] = $message_ar;
}

if ($controls->is_action('test') || $controls->is_action('save') || $controls->is_action('send') || $controls->is_action('editor')) {

    if( isset( $controls->data['subject_ar'] ) ) {
      update_option('newsletter_' . $email_id . '_ar_subject', $controls->data['subject_ar'] );
    }
    
    if( isset( $controls->data['message_ar'] ) ) {
      update_option('newsletter_' . $email_id . '_ar_message', $controls->data['message_ar'] );
    }
...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-body">
        ...
        <form method="post" action="" id="newsletter-form">
            ...
            <?php $controls->text('subject_ar', 70, 'Subject ( AR )'); ?>
                    ...
                    <?php if ($email['editor'] == 0) { ?>
                        ...
                        <div class="tnpc-preview">
                            ...
                            <div class="fake-browser-ui">
                                ...
                                <iframe id="tnpc-preview-desktop-ar" src="" width="700" height="507" alt="Test" frameborder="0"></iframe>
                            </div>

                            <!-- Flat Mobile Browser -->
                            <div class="fake-mobile-browser-ui">
                                <iframe id="tnpc-preview-mobile-ar" src="" width="250" height="445" alt="Test" frameborder="0"></iframe>
                                <div class="frame">
                                    <span class="bt-4"></span>
                                </div>
                            </div>
                        ...
                        <script type="text/javascript">
                            preview_url = ajaxurl + "?action=tnpc_preview_ar&id=<?php echo $email_id ?>";
                            jQuery('#tnpc-preview-desktop-ar, #tnpc-preview-mobile-ar').attr("src", preview_url);
                            setTimeout(function () {
                                jQuery('#tnpc-preview-desktop, #tnpc-preview-mobile').contents().find("a").click(function (e) {
                                    e.preventDefault();
                                })
