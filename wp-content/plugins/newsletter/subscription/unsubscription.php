    ...
    <div id="tnp-body"> 
        ...
        <form method="post" action="">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <th><?php _e('Unsubscription message ( AR )', 'newsletter') ?></th>
                    <td>
                        <?php $controls->wp_editor('unsubscription_text_ar'); ?>
                    </td>
                </tr>
                ...
                <tr valign="top">
                    <th><?php _e('Goodbye message ( AR )', 'newsletter') ?></th>
                    <td>
                        <?php $controls->wp_editor('unsubscribed_text_ar'); ?>
                    </td>
                </tr>
                ...
                <tr valign="top">
                    <th><?php _e('Goodbye email ( AR )', 'newsletter') ?></th>
                    <td>
                        <?php $controls->email('unsubscribed-ar', 'wordpress', false); ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>Unsubscription error ( AR )</th>
                    <td>
                        <?php $controls->wp_editor('unsubscription_error_text_ar'); ?>
                    </td>
                </tr>                       
            </table>
