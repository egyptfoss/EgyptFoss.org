...
$custom_message_key = $module->options[$message_key . '_text'];
if( pll_current_language() == 'ar' && !empty( $module->options[$message_key . '_text_ar'] ) ) {
  $custom_message_key = $module->options[$message_key . '_text_ar'];
}

$message = $newsletter->replace($custom_message_key, $user);
