                ...
                <div id="tabs-2">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <table class="newsletter-option-grid">
                                    <tr><th>Field label</th><td><?php $controls->text('email_ar', 50); ?></td></tr>
                                    <tr><th>Error message</th><td><?php $controls->text('email_error_ar', 50); ?></td></tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>Button labels ( AR )</th>
                            <td>
                                <table class="newsletter-option-grid">
                                    <tr><th>Subscribe button</th><td><?php $controls->text('subscribe_ar'); ?></td></tr>
                                    <tr><th>Save button</th><td><?php $controls->text('save_ar'); ?> (on profile page)</td></tr>
                                </table>
                                <p class="description">
                                    For "subscribe" insert an URL to an image (http://...) to use it as a graphical button.
                                </p>
