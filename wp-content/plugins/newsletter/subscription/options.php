...
if ($controls->is_action()) {
    ...
    if ($controls->is_action('test-confirmation') || $controls->is_action('test-confirmation-ar')) {
        ...
        if (count($users) == 0) {
            ...
            foreach ($users as &$user) {
                ...
                if( $controls->is_action('test-confirmation') ) {
                  $subject = $module->options['confirmation_subject'];
                  $message = $module->options['confirmation_message'];
                } else {
                  $subject = $module->options['confirmation-ar_subject'];
                  $message = $module->options['confirmation-ar_message'];
                }
                
                $res = $module->mail($user->email, $newsletter->replace($subject), $newsletter->replace($message, $user));
                if (!$res) {
            ...
            <div id="tabs">
                ...
                <div id="tabs-general">
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th>Newsletter dedicated page ( AR )</th>
                            <td>
                                <?php $controls->page('page_ar', 'The Newsletter standard unstyled page'); ?>
                                <?php
                                if (empty($controls->data['url']) && empty($controls->data['page'])) {
                                    $controls->button('create', 'Create a page for me');
                                }
                ...
                <div id="tabs-2">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th>Error page content ( AR )</th>
                            <td>
                                <?php $controls->wp_editor('error_text_ar'); ?>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="tabs-3">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th>Confirmation required message ( AR )</th>
                            <td>
                                <?php $controls->wp_editor('confirmation_text_ar'); ?>
                                <p class="description">
                                    This message is shown to just subscribed users which require to confirm the subscription
                                    following the instructions sent them with the following email. Invite them to check the mailbox and to
                                    give a look to the spam folder if no messages are received within 10 minutes.
                        ...
                        <!-- CONFIRMATION EMAIL AR -->
                        <tr valign="top">
                            <th>Confirmation email ( AR )</th>
                            <td>
                                <?php $controls->email('confirmation-ar', 'wordpress'); ?>
                                <?php $controls->button('test-confirmation-ar', 'Send a test'); ?>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="tabs-4">
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th>Welcome message ( AR )</th>
                            <td>
                                <?php $controls->wp_editor('confirmed_text_ar'); ?>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <?php $controls->email('confirmed-ar', 'wordpress', false); ?>
                                <?php $controls->button('test-confirmed-ar', 'Send a test'); ?>
                            </td>
                        </tr>
                ...
                <div id="tabs-9">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th>Profile page ( AR )</th>
                            <td>
                                <?php $controls->wp_editor('profile_text_ar'); ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <br><br>
                                email changed notice ( AR )<br>
                                <?php $controls->text('profile_email_changed_ar', 80); ?>
                                <br><br>
                                generic error<br>
                                ...
                                <br><br>
                                generic error ( AR )<br>
                                <?php $controls->text('profile_error_ar', 80); ?>
                            </td>
                        </tr>
                    </table>
                </div>
