...
<div id="buddypress">
	...
	<div class="item-list-tabs activity-type-tabs" role="navigation">
		<ul class="nav nav-tabs">
			...
			<li class="selected" id="activity-all"><a href="<?php bp_activity_directory_permalink(); ?>" title="<?php esc_attr_e( 'The public activity for everyone on this site.', 'egyptfoss' ); ?>"><?php printf( __( 'All Members %s', 'egyptfoss' ), '<span>' . bp_get_total_member_count() . '</span>' ); ?></a></li>
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) : ?>
					...
					<li id="activity-favorites"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/favorites/'; ?>" title="<?php esc_attr_e( "The activity I've marked as a favorite.", 'egyptfoss' ); ?>"><?php printf( __( 'My Favorites %s', 'egyptfoss' ), '<span>' . bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul>
			...
			<li id="activity-filter-select" class="last">
				<label for="activity-filter-by"><?php _e( 'Show:', 'egyptfoss' ); ?></label>
				<select id="activity-filter-by" class="form-control">
					<option value="-1"><?php _e( '&mdash; Everything &mdash;', 'egyptfoss' ); ?></option>
