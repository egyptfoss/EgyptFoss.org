...
<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
	<ul class="nav nav-tabs hidden">
		...
		<li id="activity-filter-select" class="last">
			...
			<select id="activity-filter-by" class="form-control input-sm">
...
wp_enqueue_script( 'ef_bp_activity', get_template_directory_uri() . '/js/bp_activity.js', array('jquery'), '', true);
?>
