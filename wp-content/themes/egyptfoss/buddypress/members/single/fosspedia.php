<header class="row">
	<div class="col-md-12">
		<h2 class="profile-page-title"><?php _e("FOSSPedia","egyptfoss"); ?></h2>
	</div>
</header>
<div class="row">
	<div class="col-md-12">
...
<div class="row">
    <div class="col-md-12">
      <?php bp_get_template_part( 'members/single/fosspedia_edits' ); ?>
    </div>
	</div>
</div>
...
<div class="change-password">
	<div class="row">
      <div class="col-md-12">
      <?php bp_get_template_part( 'members/single/fosspedia_additions' ); ?>
		</div>
	</div>
</div>
