...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/notifications'; ?>" method="post" class="standard-form" id="settings-form">
	<h4><?php _e( 'Send an email notice when:', 'buddypress' ); ?></h4>
	...
	<div class="submit">
		<input type="submit" name="submit" value="<?php esc_attr_e( 'Save', 'egyptfoss' ); ?>" id="submit" class="auto btn btn-primary" />
	</div>
