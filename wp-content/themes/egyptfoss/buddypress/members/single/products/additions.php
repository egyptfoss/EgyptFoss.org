...
$count = count(count_added_products_by_user($args, $xprofile_id));
if ($count > 0){
?>
<div class="row">
  <div class="col-md-12">
    <div class="row" id="load_user_added_product_by_ajax_container">
     <div class="col-md-12 section-container">
     	<?php get_template_part('template-parts/content', 'added_products_by_user'); ?>
     </div>
    </div>

    <div class="pagination-row clearfix view-more hidden">
      <a href="javascript:void(0);" onclick="return false;" class="btn btn-load-more" id="load_more_added_products_by_user" data-offest="20" data-count=<?php echo $count ; ?>>
