...
function ef_mlw_generate_quiz_results()
{
  if ( !current_user_can('moderate_comments') )
	...
	<div class="wrap">
			...
			<div class="tablenav-pages">
				...
				<span class="pagination-links">
					...
					if( $mlw_qmn_result_page > 0 )
					{
							...
							echo "<a class=\"prev-page\" title=\"Go to the previous page\" href=\"?page=ef_mlw_quiz_results&&mlw_result_page=$mlw_qmn_previous_page$url_query_string\"><</a>";
							echo "<span class=\"paging-input\">$mlw_current_page of $mlw_total_pages</span>";
							if( $mlw_qmn_result_left > $mlw_qmn_table_limit )
							{
								echo "<a class=\"next-page\" title=\"Go to the next page\" href=\"?page=ef_mlw_quiz_results&&mlw_result_page=$mlw_qmn_result_page$url_query_string\">></a>";
							}
						else
						{
							echo "<a class=\"next-page disabled\" title=\"Go to the next page\" href=\"?page=ef_mlw_quiz_results&&mlw_result_page=$mlw_qmn_result_page$url_query_string\">></a>";
						}
					}
					else if( $mlw_qmn_result_page == 0 )
					{
						if( $mlw_qmn_result_left > $mlw_qmn_table_limit )
						{
							echo "<a class=\"prev-page disabled\" title=\"Go to the previous page\" href=\"?page=ef_mlw_quiz_results&&mlw_result_page=$mlw_qmn_previous_page$url_query_string\"><</a>";
							echo "<span class=\"paging-input\">$mlw_current_page of $mlw_total_pages</span>";
							echo "<a class=\"next-page\" title=\"Go to the next page\" href=\"?page=ef_mlw_quiz_results&&mlw_result_page=$mlw_qmn_result_page$url_query_string\">></a>";
						}
					}
		...
		<form action='' method="get">
			...
			?>
			<input type="hidden" name="page" value="ef_mlw_quiz_results">
			<p class="search-box">
		...
		<form action="" method="post" name="bulk_delete_form">
			...
			<table class=widefat>
				<thead>
					<tr>
						...
						<th><?php _e('Username','quiz-master-next'); ?></th>
          ...
          $quotes_list .= "<td><span style='color:green;font-size:16px;'><a href='admin.php?page=ef_mlw_quiz_result_details&&result_id=".$mlw_quiz_info->result_id."'>View</a></span></td>";
          ...
          // Load user
          $user = get_userdata($mlw_quiz_info->user);
          
					$quotes_list .= "<td><span style='font-size:16px;'>" . $mlw_complete_time ."</span></td>";
					$quotes_list .= "<td><span style='font-size:16px;'><a href=\"/wp-admin/user-edit.php?user_id=$user->ID\">" . $user->user_login ."</a></span></td>";
