<?php
/**
 * Template Name: Marketplace Home.
 *
 * @package egyptfoss
 */

get_header(); 
$current_lang = (pll_current_language() == "ar") ? "ar" : "en";
$list_url = get_option('siteurl') . "/" . $current_lang . "/marketplace/services";
?>
...
<div class="container">
	<div class="row">
		<div id="primary" class="content-area col-md-12">
			...
			<div class="row text-center mt60_px">
				<div class="col-md-4">
					...
					<h3><?php echo __('Offer Your Services','egyptfoss'); ?></h3>
				...
				<div class="col-md-4">
					...
					<h3><?php echo __('Find the Right Providers','egyptfoss'); ?></h3>
      ...
      <?php  
          ...
          // list top services slider
          get_template_part('template-parts/content', 'top_service');
          
          // list top providers slider
          get_template_part('template-parts/content', 'top_provider'); 
      ?>
			<div class="row text-center mt60_px">
				<div class="col-md-12">
            ...
            <?php
            // to take full width if no many categories
            $col_number = 4;
							...
							<ul class="list-unstyled services-list">
								<?php for ($i = 0 ; $i < count($categories); $i++) {
									...
									<li>
										...
										<span class="inner-count">(<?php echo ef_get_category_posts_count( 'service', 'service_category', $category->term_id ); ?>)</span>
									</li>
								<?php } ?>
							</ul>
						</div>
