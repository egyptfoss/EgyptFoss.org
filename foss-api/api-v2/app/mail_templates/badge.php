<?php include(getcwd() . '/app/mail_templates/header.php'); ?>
<tr>
  <td class="foss-msg-body" style="text-align:center;padding:10px;">
    <?php if (isset($template_inputs['user_name'])) { ?>
    <p style="text-align:center;">
    <?php echo __("Hi", "efbadges",$preferred_language) . ' ' . $template_inputs['user_name']; ?>
    </p>
  <?php } ?>
  <p style="text-align:center;"><?php echo $template_inputs['message']; ?></p>
  <br>
...
<?php include(getcwd() . '/app/mail_templates/footer.php'); ?>