...
class WPOpenDataSetController extends EgyptFOSSController {
   ...
   *   @SWG\Parameter(name="resources", in="formData", required=true, type="file", description="Open dataset Resources <br/><b>Validations: </b><br/> 1. Resources should be one of the following extenstions [PDF,CSV,JSON,XML,HTML] <br/> <b>[Required]</b>"),
   ...
   *   @SWG\Parameter(name="dataset_format", in="query", required=false, type="string", description="Filter list of open dataset by resource format <br/> <b>Values: </b><br/> 1.pdf <br/>2.json <br/>3.csv <br/>4.xml <br/>5.html <br/>"), 
  ...
  {
    $extensions = array('pdf','json','csv','xml','html');
    return $extensions;
  }
  
  function returnValidFormat($ext)
  {
      $extension_mime_types = array('pdf'=>'application/pdf','json'=>'application/json','csv'=>'text/csv','xml'=>'text/xml','html'=>'text/html');
      return $extension_mime_types[strtolower($ext)];
  }
  
  function returnValidMime($ext)
  {
      $extension_mime_types = array('application/pdf'=>'pdf',
          'application/json'=>'json','text/csv'=>'csv','text/xml'=>'xml','text/html'=>'html');
      return $extension_mime_types[strtolower($ext)];
  }
