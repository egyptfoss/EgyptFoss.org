# Generated by DBDiff
# On 06/05/2016 03:58:47 pm

SET @lastInsertedPost = (SELECT max(ID) from wpRuvF8_posts);
SET @newPostId = (select @lastInsertedPost) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-06-05 14:53:00','2016-06-05 14:53:00','','Request Thread','','publish','closed','closed','','request-thread','','','2016-06-05 14:53:00','2016-06-05 14:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @newPostId),'_wp_page_template','template-request-thread.php');

SET @arabicPostId = (select @newPostId) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-06-05 14:53:00','2016-06-05 14:53:00','','إقترح قاعدة بيانات مفتوحة','','publish','closed','closed','','ar-request-thread','','','2016-04-26 15:53:00','2016-04-26 15:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','template-request-thread.php');
