...
SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'maps' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_en);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);

SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'request_center' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_en);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);

SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'ar-request_center' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_en);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);
# end duplicated menus
...
SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'events-2' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_en);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);

SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'events-3' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_en);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);
...
SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'open_dataset' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_en);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);

SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'success_story' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_en);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);

SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'maps-2' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_en);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);

SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'request_center-2' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_en);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);
...
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-07-24 17:33:00','2016-07-24 17:33:00','','News','','publish','closed','closed','','news','','','2016-07-24 17:33:00','2016-07-24 17:33:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'1','nav_menu_item','','0');
...
SET @newPostId = (SELECT max(ID) from wpRuvF8_posts) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-07-24 17:33:00','2016-07-24 17:33:00','','Events','','publish','closed','closed','','events','','','2016-07-24 17:33:00','2016-07-24 17:33:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'2','nav_menu_item','','0');
INSERT INTO `wpRuvF8_term_relationships` VALUES((select @newPostId),(select @nav_menu_tax_en),'0');
...
SET @newPostId = (SELECT max(ID) from wpRuvF8_posts) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-07-24 17:33:00','2016-07-24 17:33:00','','Products','','publish','closed','closed','','products','','','2016-07-24 17:33:00','2016-07-24 17:33:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'3','nav_menu_item','','0');
INSERT INTO `wpRuvF8_term_relationships` VALUES((select @newPostId),(select @nav_menu_tax_en),'0');
...
SET @newPostId = (SELECT max(ID) from wpRuvF8_posts) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-07-24 17:33:00','2016-07-24 17:33:00','','FOSSPedia','','publish','closed','closed','','fosspedia','','','2016-07-24 17:33:00','2016-07-24 17:33:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'4','nav_menu_item','','0');
INSERT INTO `wpRuvF8_term_relationships` VALUES((select @newPostId),(select @nav_menu_tax_en),'0');
...
SET @newPostId = (SELECT max(ID) from wpRuvF8_posts) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-07-24 17:33:00','2016-07-24 17:33:00','','Open Data','','publish','closed','closed','','open-dataset','','','2016-07-24 17:33:00','2016-07-24 17:33:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'5','nav_menu_item','','0');
INSERT INTO `wpRuvF8_term_relationships` VALUES((select @newPostId),(select @nav_menu_tax_en),'0');
...
SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = '%d8%a7%d9%84%d8%a7%d8%ae%d8%a8%d8%a7%d8%b1' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_ar);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);

SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'events_ar' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_ar);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);
...
SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'ar-success_story' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_ar);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);

SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'ar-open_dataset' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_ar);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);

SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'fosspedia_ar' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_ar);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);
...
SET @itemId = (SELECT ID FROM wpRuvF8_posts where post_name = 'ar-request_center-2' and post_type = 'nav_menu_item' limit 1);
delete from `wpRuvF8_term_relationships` where object_id = (select @itemId) and term_taxonomy_id = (select @nav_menu_tax_ar);
delete from `wpRuvF8_postmeta` where post_id = (select @itemId);
delete from `wpRuvF8_posts` where ID = (select @itemId);
