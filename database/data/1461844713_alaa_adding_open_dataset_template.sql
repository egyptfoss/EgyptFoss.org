...
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-04-26 11:53:00','2016-04-26 11:53:00','','Suggest Open DataSet','','publish','closed','closed','','suggest-open-dataset','','','2016-04-26 11:53:00','2016-04-26 11:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @newPostId),'_wp_page_template','template-add-open-dataset.php');

SET @arabicPostId = (select @newPostId) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-04-26 11:53:00','2016-04-26 11:53:00','','إقترح قاعدة بيانات مفتوحة','','publish','closed','closed','','ar-suggest-open-dataset','','','2016-04-26 15:53:00','2016-04-26 15:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','template-add-open-dataset.php');

INSERT INTO `wpRuvF8_terms` VALUES (NULL,'pll_5721fba97cad4','pll_5721fba97cad4','0','pll_5721fba97cad4');
