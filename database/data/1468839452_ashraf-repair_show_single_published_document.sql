...
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-07-18 11:53:00','2016-07-18 11:53:00','','View Document','','publish','closed','closed','','view-document','','','2016-06-09 11:53:00','2016-05-04 11:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @newPostId),'_wp_page_template','template-single-document.php');

SET @arabicPostId = (select @newPostId) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-07-18 11:53:00','2016-07-18 11:53:00','','View Document Ar','','publish','closed','closed','','view-document-ar','','','2016-07-18 15:53:00','2016-07-18 15:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','template-single-document.php');

INSERT INTO `wpRuvF8_terms` VALUES (NULL,'pll_578cb7461b087','pll_578cb7461b087','0','pll_578cb7461b087');
