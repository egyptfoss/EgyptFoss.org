...
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-02-28 15:53:00','2016-02-28 15:53:00','','Add News','','publish','closed','closed','','add-news','','','2016-02-28 15:53:00','2016-02-28 15:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @newPostId),'_wp_page_template','template-manage-news.php');

SET @arabicPostId = (select @newPostId) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-01-28 15:23:00','2016-01-28 15:23:00','','اضف خبر جديد','','publish','closed','closed','','%d8%a7%d8%b6%d9%81-%d8%ae%d8%a8%d8%b1-%d8%ac%d8%af%d9%8a%d8%af','','','2016-02-28 15:53:00','2016-02-28 15:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','template-manage-news.php');

INSERT INTO `wpRuvF8_terms` VALUES (NULL,'pll_56d2f692d9e86','pll_56d2f692d9e86','0','pll_56d2f692d9e86');
