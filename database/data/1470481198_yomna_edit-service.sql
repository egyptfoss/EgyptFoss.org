# Generated by DBDiff
# On 08/06/2016 01:00:58 pm

SET @lastInsertedPost = (SELECT max(ID) from wpRuvF8_posts);
SET @newPostId = (select @lastInsertedPost) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-08-06 01:00:00','2016-08-06 01:00:00','','Edit service','','publish','closed','closed','','edit-service','','','2016-08-06 01:00:00','2016-08-06 01:00:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @newPostId),'_wp_page_template','MarketPlace/template-edit-service.php');

SET @arabicPostId = (select @newPostId) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-08-06 01:00:00','2016-08-06 01:00:00','','تعديل خدمة','','publish','closed','closed','','ar-edit-service','','','2016-08-06 01:00:00','2016-08-06 01:00:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','MarketPlace/template-edit-service.php');

INSERT INTO `wpRuvF8_terms` VALUES (NULL,'pll_57a5c482b1ef2','pll_57a5c482b1ef2','0','pll_57a5c482b1ef2');
