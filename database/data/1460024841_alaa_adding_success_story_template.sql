...
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-04-07 11:53:00','2016-04-07 11:53:00','','Suggest Success Story','','publish','closed','closed','','add-success-story','','','2016-04-07 11:53:00','2016-04-07 11:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @newPostId),'_wp_page_template','template-add-success-story.php');

SET @arabicPostId = (select @newPostId) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-04-07 11:53:00','2016-04-07 11:53:00','','إقترح قصة نجاح جديدة','','publish','closed','closed','','ar-add-success-story','','','2016-02-28 15:53:00','2016-02-28 15:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','template-add-success-story.php');

INSERT INTO `wpRuvF8_terms` VALUES (NULL,'pll_5706250399216','pll_5706250399216','0','pll_5706250399216');
