...
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-04-07 11:53:00','2016-04-07 11:53:00','','Activist Center','','publish','closed','closed','','activist-center','','','2016-04-07 11:53:00','2016-04-07 11:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @newPostId),'_wp_page_template','template-activist-center.php');

SET @arabicPostId = (select @newPostId) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-04-07 11:53:00','2016-04-07 11:53:00','','Activist Center','','publish','closed','closed','','ar-activist-center','','','2016-02-28 15:53:00','2016-02-28 15:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','template-activist-center.php');

INSERT INTO `wpRuvF8_terms` VALUES (NULL,'pll_57e11d33b31da','pll_57e11d33b31da','0','pll_57e11d33b31da');
