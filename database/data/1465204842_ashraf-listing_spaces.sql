...
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-05-04 11:53:00','2016-05-04 11:53:00','','list spaces','','publish','closed','closed','','listing-spaces','','','2016-05-04 11:53:00','2016-05-04 11:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @newPostId),'_wp_page_template','template-listing-spaces.php');

SET @arabicPostId = (select @newPostId) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-05-04 11:53:00','2016-05-04 11:53:00','','list spaces ar','','publish','closed','closed','','listing-spaces','','','2016-05-04 15:53:00','2016-05-04 15:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','template-listing-spaces.php');

INSERT INTO `wpRuvF8_terms` VALUES (NULL,'pll_5755415b90db8','pll_5755415b90db8','0','pll_5755415b90db8');
