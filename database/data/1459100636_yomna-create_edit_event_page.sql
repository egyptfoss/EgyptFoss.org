# Generated by DBDiff
# On 03/27/2016 08:43:56 pm

SET @lastInsertedPost = (SELECT max(ID) from wpRuvF8_posts);
SET @newPostId = (select @lastInsertedPost) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-03-27 20:53:00','2016-03-27 20:53:00','','Edit event','','publish','closed','closed','','edit-event','','','2016-03-27 20:53:00','2016-03-27 20:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @newPostId),'_wp_page_template','template-edit-event.php');

SET @arabicPostId = (select @newPostId) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-03-27 20:53:00','2016-03-27 20:53:00','','تعديل فاعلية','','publish','closed','closed','','ar-edit-event','','','2016-03-27 20:53:00','2016-03-27 20:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','template-edit-event.php');

INSERT INTO `wpRuvF8_terms` VALUES (NULL,'pll_56f81d214d2ea','pll_56f81d214d2ea','0','pll_56f81d214d2ea');
