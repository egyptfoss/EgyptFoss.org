...
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-06-01 15:47:18','2016-06-01 15:47:18','','Request Center','','publish','closed','closed','','request_center','','','2016-06-01 15:47:18','2016-06-01 15:47:18','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'8','nav_menu_item','','0');
...
SET @newPostId = (SELECT max(ID) from wpRuvF8_posts) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-06-01 15:47:18','2016-06-01 15:47:18','','مركز الطلبات','','publish','closed','closed','','ar-request_center','','','2016-06-01 15:47:18','2016-06-01 15:47:18','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'8','nav_menu_item','','0');
