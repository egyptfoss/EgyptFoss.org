...
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-06-15 11:53:00','2016-06-15 11:53:00','','Add Document','','publish','closed','closed','','add-document','','','2016-06-15 11:53:00','2016-06-15 11:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @newPostId),'_wp_page_template','CollaborationCenter/template-add-document.php');

SET @arabicPostId = (select @newPostId) + 1;
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-06-15 11:53:00','2016-06-15 11:53:00','','أضف ملف','','publish','closed','closed','','ar-add-document','','','2016-06-15 15:53:00','2016-06-15 15:53:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','CollaborationCenter/template-add-document.php');

INSERT INTO `wpRuvF8_terms` VALUES (NULL,'pll_575fd7b4f2f79','pll_575fd7b4f2f79','0','pll_575fd7b4f2f79');
