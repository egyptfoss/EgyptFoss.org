...
INSERT INTO `wpRuvF8_posts` VALUES((select @newPostId),'1','2016-07-27 14:19:00','2016-07-27 14:19:00','','Edit Thought','','publish','closed','closed','','add-expert-thought','','','2016-07-27 14:19:00','2016-07-27 14:19:00','','0',concat('http://egyptfoss.com/?page_id=',(select @newPostId)),'0','page','','0');
...
INSERT INTO `wpRuvF8_posts` VALUES((select @arabicPostId),'1','2016-07-27 14:19:00','2016-07-27 14:19:00','','تعديل رأي','','publish','closed','closed','','ar-add-expert-thought','','','2016-07-27 14:19:00','2016-07-27 14:19:00','','0',concat('http://egyptfoss.com/?page_id=',(select @arabicPostId)),'0','page','','0');
INSERT INTO `wpRuvF8_postmeta` VALUES (NULL,(select @arabicPostId),'_wp_page_template','template-edit-expert-thought.php');
